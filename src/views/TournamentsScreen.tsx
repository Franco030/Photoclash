...
import { useTournamentsViewModel } from '../viewmodels/useTournamentsViewModel';

const TournamentsScreen = ({ navigation }: any) => {
    const { tournaments, isLoading, error } = useTournamentsViewModel();
        ...
        <View className="flex-1 bg-gray-50 p-4">
            ...
            {isLoading && (
                <View className="flex-1 justify-center items-center">
                    ...
                    <Text className="text-pastel-blue mt-4 font-medium">Cargando torneos...</Text>
                </View>
            )}

            {error && (
                <View className="flex-1 justify-center items-center">
                    <Text className="text-pastel-pink font-bold text-lg">{error}</Text>
                </View>
            )}
